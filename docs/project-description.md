# Project Documentation: Git & Python Fundamentals

## 📌 Purpose
The objective of this project is to demonstrate proficiency in **Git version control** and **Modular Python Programming**. By separating logic into utility scripts and executing them via a main entry point, this repository follows professional software development standards used in data engineering and analysis.
...
1. Mastered the "Stage-Commit-Push" workflow.
2. Successfully managed merge conflicts and branch deletions.
3. Practiced professional documentation using Markdown.